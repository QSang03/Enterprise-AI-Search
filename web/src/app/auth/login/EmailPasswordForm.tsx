        ...
        onSubmit={async (values: { email: string; password: string }) => {
          ...
          if (isSignup) {
            ...
            if (!response.ok) {
              ...
              setApiStatus("error");
              toast.error(t("auth.failedSignUp", { error: errorMsg }));
              setIsWorking(false);
              return;
            } else {
          ...
          if (loginResponse.ok) {
            ...
            if (errorDetail === "LOGIN_BAD_CREDENTIALS") {
              ...
              errorMsg = t("auth.createAccountSetPassword");
            ...
            setErrorMessage(errorMsg);
            setApiStatus("error");
            toast.error(t("auth.failedLogin", { error: errorMsg }));
          }
        }}
      >
